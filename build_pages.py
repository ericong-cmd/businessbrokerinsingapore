...
PAGES.append({
    ...
    "description": "How to sell your business in Singapore confidentially: valuation, vetted buyers under NDA, negotiation and completion — with zero upfront fees. For SMEs with S$2M–S$20M revenue.",
...
PAGES.append({
    ...
    "title": "Business Valuation Singapore — How Much Is My Business Worth?",
...
PAGES.append({
    ...
    "description": "Business broker fees in Singapore explained: typical market rates of 5–10%, and our published success-only schedule — 5% up to S$5M down to 1% above S$50M, S$100k minimum, zero upfront.",
...
PAGES.append({
    ...
    "description": "The seven stages of selling a business in Singapore, from confidential valuation to completion — what happens in each stage, how long it takes, and what you'll be asked for.",
...
PAGES.append({
    ...
    "title": "Sell Your F&B Business in Singapore — Restaurants & Food Manufacturing",
    "description": "How to sell an F&B business in Singapore: 2.5–5× EBITDA multiples, SFA licences, lease transfer, halal certification, and a confidential process that keeps staff and landlords unaware.",
...
PAGES.append({
    ...
    "description": "Buy an established SME business in Singapore: off-market deal flow from mandated sellers, S$2M–S$20M revenue range, 1% success-only buyer fee. Register your acquisition criteria.",
...
PAGES.append({
    "slug": "contact",
    "crumb": "Contact",
    "title": "Contact — Business Broker In Singapore",
    "description": "Start a confidential conversation about selling or buying a Singapore business. WhatsApp +65 8951 8821 — no fee, no obligation, and your name stays private.",
...
PAGES.append({
    "slug": "faq",
    "crumb": "FAQ",
    "title": "Selling a Business in Singapore — FAQ | Business Broker In Singapore",
    "description": "Straight answers to the questions Singapore business owners ask before selling: tax on sale proceeds, timelines, confidentiality, partner deadlock, foreign buyers, broker fees and more.",
